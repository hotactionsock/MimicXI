...
-----------------------------------
-- Human-readable labels per augment id (the '+1' unit template).
-- The Gold Casket preview (showRareItemContents in scripts/globals/
-- caskets.lua) substitutes the rolled value into these.
-----------------------------------
xi.augments      = xi.augments or {}
xi.augments.name = xi.augments.name or {}

xi.augments.name[23  ] = 'Accuracy+1'
xi.augments.name[25  ] = 'Attack+1'
xi.augments.name[31  ] = 'Evasion+1'
xi.augments.name[35  ] = 'Mag.Acc.+1'
xi.augments.name[41  ] = 'Crit.hit rate+1%'
xi.augments.name[44  ] = 'Store TP+1 / Subtle Blow+1'
xi.augments.name[512 ] = 'STR+1'
xi.augments.name[513 ] = 'DEX+1'
xi.augments.name[514 ] = 'VIT+1'
xi.augments.name[515 ] = 'AGI+1'
xi.augments.name[516 ] = 'INT+1'
xi.augments.name[517 ] = 'MND+1'
xi.augments.name[17  ] = 'HP+1 MP+1'
xi.augments.name[19  ] = 'HP+1 MP-1'
xi.augments.name[21  ] = 'HP-1 MP+1'
xi.augments.name[27  ] = 'Rng.Acc.+1'
xi.augments.name[29  ] = 'Rng.Atk.+1'
xi.augments.name[37  ] = 'Mag.Evasion+1'
xi.augments.name[68  ] = 'Acc+1 Atk+1'
xi.augments.name[69  ] = 'Rng.Acc.+1 Rng.Atk.+1'
xi.augments.name[78  ] = 'HP+2 per unit'
xi.augments.name[82  ] = 'MP+2 per unit'
xi.augments.name[129 ] = 'Acc+1 Rng.Acc.+1'
xi.augments.name[130 ] = 'Atk+1 Rng.Atk.+1'
xi.augments.name[131 ] = 'Mag.Acc.+1 Mag.Atk.Bns.+1'
xi.augments.name[195 ] = 'Subtle Blow+1'
xi.augments.name[54  ] = 'Phys. dmg. taken -1%'
xi.augments.name[55  ] = 'Magic dmg. taken -1%'
xi.augments.name[79  ] = 'HP+3 per unit'
xi.augments.name[80  ] = 'Mag.Acc.+1 Mag.Dmg+1'
xi.augments.name[83  ] = 'MP+3 per unit'
xi.augments.name[132 ] = 'Dbl.Atk.+1% Crit.hit rate+1%'
xi.augments.name[133 ] = 'Mag.Atk.Bns.+1'
xi.augments.name[134 ] = 'Mag.Def.Bns.+1'
xi.augments.name[137 ] = 'Regen+1'
xi.augments.name[138 ] = 'Refresh+1'
xi.augments.name[140 ] = 'Fast Cast+1%'
xi.augments.name[141 ] = 'Conserve MP+1'
xi.augments.name[142 ] = 'Store TP+1'
xi.augments.name[143 ] = 'Dbl.Atk.+1%'
xi.augments.name[49  ] = 'Haste+1%'
xi.augments.name[144 ] = 'Triple Atk.+1%'
xi.augments.name[146 ] = 'Dual Wield+1'
xi.augments.name[147 ] = 'Treasure Hunter+1'
xi.augments.name[211 ] = 'Snapshot+1'
xi.augments.name[327 ] = 'Weapon skill damage+1%'
xi.augments.name[328 ] = 'Crit. hit damage+1%'
xi.augments.name[329 ] = 'Cure potency+1%'
xi.augments.name[333 ] = 'Conserve TP+1'
xi.augments.name[550 ] = 'STR+1 DEX+1'
xi.augments.name[551 ] = 'STR+1 VIT+1'
xi.augments.name[552 ] = 'STR+1 AGI+1'
xi.augments.name[553 ] = 'DEX+1 AGI+1'
xi.augments.name[554 ] = 'INT+1 MND+1'
xi.augments.name[555 ] = 'MND+1 CHR+1'
xi.augments.name[556 ] = 'INT+1 MND+1 CHR+1'
xi.augments.name[557 ] = 'STR+1 CHR+1'
xi.augments.name[558 ] = 'STR+1 INT+1'
xi.augments.name[559 ] = 'STR+1 MND+1'
xi.augments.name[145 ] = 'Counter+1'
xi.augments.name[354 ] = 'Quadruple Attack+1%'
xi.augments.name[362 ] = 'Magic Damage+1'
xi.augments.name[526 ] = 'STR+1 DEX-1 VIT-1'
xi.augments.name[527 ] = 'STR+1 DEX-1 AGI-1'
xi.augments.name[528 ] = 'STR+1 VIT-1 AGI-1'
xi.augments.name[529 ] = 'STR-1 DEX+1 VIT-1'
xi.augments.name[530 ] = 'STR-1 DEX+1 AGI-1'
xi.augments.name[531 ] = 'DEX+1 VIT-1 AGI-1'
xi.augments.name[532 ] = 'STR-1 DEX-1 VIT+1'
xi.augments.name[533 ] = 'STR-1 VIT+1 AGI-1'
xi.augments.name[534 ] = 'DEX-1 VIT+1 AGI-1'
xi.augments.name[535 ] = 'STR-1 DEX-1 AGI+1'
xi.augments.name[536 ] = 'STR-1 VIT-1 AGI+1'
xi.augments.name[537 ] = 'DEX-1 VIT-1 AGI+1'
xi.augments.name[538 ] = 'AGI+1 INT-1 MND-1'
xi.augments.name[539 ] = 'AGI+1 INT-1 CHR-1'
xi.augments.name[540 ] = 'AGI+1 MND-1 CHR-1'
xi.augments.name[541 ] = 'AGI-1 INT+1 MND-1'
xi.augments.name[542 ] = 'AGI-1 INT+1 CHR-1'
xi.augments.name[543 ] = 'INT+1 MND-1 CHR-1'
xi.augments.name[544 ] = 'AGI-1 INT-1 MND+1'
xi.augments.name[545 ] = 'AGI-1 MND+1 CHR-1'
xi.augments.name[546 ] = 'INT-1 MND+1 CHR-1'
xi.augments.name[547 ] = 'AGI-1 INT-1 CHR+1'
xi.augments.name[548 ] = 'AGI-1 MND-1 CHR+1'
xi.augments.name[549 ] = 'INT-1 MND-1 CHR+1'
xi.augments.name[320 ] = 'Blood Pact ability delay -1'
xi.augments.name[321 ] = 'Avatar perpetuation cost -1'

-- Plain single-stat ids used by the per-item augment pools (xi.augments.id in
-- casket_loot_starter_zones.lua). `or` keeps the augmentDefs labels above.
xi.augments.name[1  ] = xi.augments.name[1  ] or 'HP+1'
xi.augments.name[9  ] = xi.augments.name[9  ] or 'MP+1'
xi.augments.name[33 ] = xi.augments.name[33 ] or 'Defense+1'
xi.augments.name[518] = xi.augments.name[518] or 'CHR+1'
